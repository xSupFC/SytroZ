...
local themes = {
	...
	Glow = Color3.fromRGB(86, 76, 251), 
	Accent = Color3.fromRGB(38, 45, 101), 
	LightContrast = Color3.fromRGB(86, 76, 251), 
	DarkContrast = Color3.fromRGB(38, 45, 80),  
