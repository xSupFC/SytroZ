...
Frame.Position = UDim2.new(0.999,0,0.7)
...
TweenService:Create(Frame, TweenInfo.new(.20, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Position = UDim2.new(0.999,0,0.7)}):Play()
wait(.20)
MessageGui:Destroy()
end
...
function Library:Create(xHubName,xGameName)
    ...
    Main.Position = UDim2.new(0.15,0,0.1)
    ...
    HubName.Position = UDim2.new(0, 3, 0.024324324, 0)
    ...
    Line.Position = UDim2.new(0.0942857179, 0, 0.148648649, 0)
    ...
    ActualSide.Position = UDim2.new(0, 5, 0.172972977, 0)
    ...
    SideLine.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    GameName.Position = UDim2.new(0.01714285718, 0, 0.0810810775, 0)
    ...
    function xTabs:Tab(Name,xVisible)
        ...
        function Elements:Toggle(Name,value,Callback)
            ...
            ToggleButton.MouseButton1Click:Connect(function()
                ...
                if ToggleEnabled then 
                    game:GetService("TweenService"):Create(ToggleCircle, TweenInfo.new(0.3), {ImageColor3 = Color3.fromRGB(0, 255, 0)}):Play() 
                    game:GetService("TweenService"):Create(ToggleCircle, TweenInfo.new(0.3), {Position = UDim2.new(0.559, 0,0.153, 0)}):Play() 
                else
                    game:GetService("TweenService"):Create(ToggleCircle, TweenInfo.new(0.3), {ImageColor3 = Color3.fromRGB(255, 0, 0)}):Play() 
...
--[[
        ...
        function Elements:Dropdown(text, list, callback)
            ...
            Dropdown.Size = UDim2.new(0, 408, 0, 42)
            ...
            DropdownBtn.Size = UDim2.new(0, 408, 0, 35)
            ...
            ArrowImg.Position = UDim2.new(1.85240645, 0, 0.190476194, 0)
            ...
            DropItemHolder.Size = UDim2.new(0, 408, 0, 35)
            ...
            DropdownBtn.MouseButton1Click:Connect(
                function()
                    if droptog == false then
                        Dropdown:TweenSize(
                            UDim2.new(0, 408, 0, 55 + framesize),
            ...
            for i, v in next, list do
                ...
                if itemcount <= 3 then
                    ...
                    DropItemHolder.Size = UDim2.new(0, 408, 0, framesize)
                end
                ...
                Item.Size = UDim2.new(0, 388, 0, 25)
